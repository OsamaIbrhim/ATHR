        ...
        if (!cached) {
          notify(
            error instanceof ApiError && error.code === 'NETWORK_ERROR'
              ? 'بيانات الجهاز والوردية غير مجهزة للبيع دون اتصال. شغّل الإنترنت مرة واحدة لإكمال التجهيز.'
      ...
      try {
        ...
        if (
          ...
          try {
            ...
            notify(
              context
                ? 'تم فتح الوردية المحفوظة وأصبح البيع متاحًا في وضع عدم الاتصال.'
                : 'تم فتح الوردية المحفوظة للعرض فقط. يلزم الاتصال بالخادم مرة واحدة لتجهيز البيع دون اتصال.',
              'info',
            )
          } catch {
            await clearShiftState()
