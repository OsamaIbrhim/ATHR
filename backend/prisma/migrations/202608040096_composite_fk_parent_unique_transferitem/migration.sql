-- WP-007 Phase B (MT-MIG-006): same-tenant composite FK support for "TransferItem".
...
ALTER TABLE "TransferItem" ADD CONSTRAINT "TransferItem_tenant_id_id_key" UNIQUE ("tenant_id", "id");
