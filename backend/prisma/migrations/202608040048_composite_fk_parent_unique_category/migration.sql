-- WP-007 Phase B (MT-MIG-006): same-tenant composite FK support for "Category".
...
ALTER TABLE "Category" ADD CONSTRAINT "Category_tenant_id_id_key" UNIQUE ("tenant_id", "id");
