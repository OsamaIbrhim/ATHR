-- WP-007 Phase B (MT-MIG-006): same-tenant composite FK support for "PurchaseInvoiceItem".
...
ALTER TABLE "PurchaseInvoiceItem" ADD CONSTRAINT "PurchaseInvoiceItem_tenant_id_id_key" UNIQUE ("tenant_id", "id");
