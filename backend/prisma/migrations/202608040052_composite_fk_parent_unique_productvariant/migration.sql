-- WP-007 Phase B (MT-MIG-006): same-tenant composite FK support for "ProductVariant".
...
ALTER TABLE "ProductVariant" ADD CONSTRAINT "ProductVariant_tenant_id_id_key" UNIQUE ("tenant_id", "id");
