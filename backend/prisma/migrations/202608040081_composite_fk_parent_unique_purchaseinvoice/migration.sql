-- WP-007 Phase B (MT-MIG-006): same-tenant composite FK support for "PurchaseInvoice".
...
ALTER TABLE "PurchaseInvoice" ADD CONSTRAINT "PurchaseInvoice_tenant_id_id_key" UNIQUE ("tenant_id", "id");
