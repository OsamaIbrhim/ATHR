-- WP-007 Phase B (MT-MIG-006): same-tenant composite FK support for "Customer".
...
ALTER TABLE "Customer" ADD CONSTRAINT "Customer_tenant_id_id_key" UNIQUE ("tenant_id", "id");
