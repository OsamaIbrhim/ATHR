-- WP-007 Phase B (MT-MIG-006): same-tenant composite FK support for "Transfer".
...
ALTER TABLE "Transfer" ADD CONSTRAINT "Transfer_tenant_id_id_key" UNIQUE ("tenant_id", "id");
